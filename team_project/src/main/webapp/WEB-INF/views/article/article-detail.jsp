				...
				<div class="blog__details__content">
					<div class="blog__details__text">
						<p>As a result the last couple of eps haven’t been super
							...
							growth here but it’s subtle (apart from Shouyou, arguably).&nbsp;
							I mean, Tobio being an asshole is nothing new – it’s kind of the
							foundation of his entire character arc.&nbsp; Confronting whether
							his being an asshole is a problem for the Crows this directly is
							a bit of an evolution, and probably an overdue one at that, but
					...
					<div class="blog__details__item__text">
						...
						<p>In Japan the idea of a first-year speaking to a senior the
							way Kageyama did to Asahi is a lot more shocking than it would be
					...
					<div class="blog__details__comment">
						...
						<div class="blog__details__comment__item">
							<div class="blog__details__comment__item__pic">
								<img src="resources/img/blog/details/comment-1.png" alt="">
							</div>
