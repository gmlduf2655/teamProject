					...
					<div class="col-md-3">
						<div class="product__item">
							<div class="product__item__pic set-bg"
								...
								onclick="location.href='/event/event_read?event_no=${eventVo.event_no}';">
				...
				<ul class="pagination justify-content-center">
					<c:if test="${pagingDto.startPage!=1}">
						<li class="page-item"><a class="page-link"
							href="/event/event_list?page=${pagingDto.startPage-1}">이전</a></li>
					</c:if>
					<c:forEach begin="${pagingDto.startPage}"
						...
						<c:otherwise>
							...
							href="/event/event_list?page=${i}">${i}</a>
						</li>
					</c:forEach>
					<c:if test="${pagingDto.endPage!=pagingDto.totalPage}">
						<li class="page-item"><a class="page-link"
							href="/event/event_list?page=${pagingDto.endPage + 1}">다음</a></li>
					</c:if>
				</ul>
			</nav>
		</div>
