...
public class EventPagingDto {
		...
		private int endRow = 12; // 종료 행
		private String searchType; // 찾으려는 방식 
		private String keyword; // 키워드
		private int perPage = 12; // 각 페이지당 글 수
		...
		// 필드 생성자
		public EventPagingDto(int page, int startRow, int endRow, String searchType, String keyword, int perPage, int totalPage,
